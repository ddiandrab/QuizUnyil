...
public class Soal3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Raja Ampat menjadi primadona baru di dunia pariwisata Indonesia yang merupakan pulau di ...");
        a.setText("Lombok");
        b.setText("Medan");
        c.setText("Papua");
        d.setText("Nusa Tenggara Timur");
        gambar.setImageResource(R.drawable.tempat3);
