package com.example.aspire4739.quizunyil_pa.sejarah;
...
public class Soal2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Singkatan dari BPUPKI adalah ...");
        a.setText("Badan Penyakit Usaha Keliling Indonesia");
        b.setText("Badan Penyelidik Usaha Kemerdekaan indonesia");
        c.setText("Badan pelayaran usaha kementrian indonesia");
        d.setText("Badan penyelidik usaha kementrian Indonesia");
