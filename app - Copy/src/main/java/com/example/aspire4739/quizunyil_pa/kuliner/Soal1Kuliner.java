...
public class Soal1Kuliner extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Salah satu bahan dasar untuk membuat klepon adalah");
        a.setText("Belimbing");
        b.setText("Gula Merah");
        c.setText("Jagung");
        d.setText("Ayam");
        gambar.setImageResource(R.drawable.kuliner1);
