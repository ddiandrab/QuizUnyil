...
public class Soal3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Siapa pencipta Tari Beksan Wireng?");
        a.setText("a. Dewi Rantam sari");
        b.setText("b. Pangera Diponegoro");
        c.setText("c. Endang caturwatir");
        d.setText("d. Prabu Amiluhur");
        gambar.setImageResource(R.drawable.tari3);
