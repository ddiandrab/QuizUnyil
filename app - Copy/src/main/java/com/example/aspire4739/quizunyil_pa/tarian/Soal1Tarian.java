...
import com.example.aspire4739.quizunyil_pa.rumah.*;
...
public class Soal1Tarian extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Dimana biasanya Tari Reog Ponorogo, kesenian yang berasal dari Ponorogo, Jawa Timur ini dipentaskan?");
        a.setText("a. Acara Kematian");
        b.setText("b. Acara Pernikahan");
        c.setText("c. Acara Keagamaan");
        d.setText("d. Semua Acara");
        gambar.setImageResource(R.drawable.tari1);
