...
public class Soal1Rumah extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Rumah betang berasal dari provinsi . . .");
        a.setText("DKI Jakarta");
        b.setText("Sumatra Selatan");
        c.setText("Kalimantan Barat");
        d.setText("Lampung");
        gambar.setImageResource(R.drawable.rumah1);
