package com.example.aspire4739.quizunyil_pa.tarian;
...
public class Soal5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Tarian tradisional pertama adalah Bedhaya Ketawang yang mengandung arti di setiap masing-masing kata. ‘bedhaya’ yang artinya … dan ‘ketawang’ artinya...");
        a.setText("a. Penari wanita dan langit");
        b.setText("b. Langit dan penari Wanita");
        c.setText("c. Budaya dan laut");
        d.setText("d. Laut dan Budaya");
        gambar.setImageResource(R.drawable.tari5);
