package com.example.aspire4739.quizunyil_pa.kuliner;
...
public class Soal2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Nama provinsi makanan khas tradisional ini adalah");
        a.setText("Sumatra Barat");
        b.setText("Sumatra Utara");
        c.setText("Sumatra Selatan");
        d.setText("Sumatra Tenggara");
        gambar.setImageResource(R.drawable.kuliner2);
