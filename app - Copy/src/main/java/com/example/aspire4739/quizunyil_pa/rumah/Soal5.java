package com.example.aspire4739.quizunyil_pa.rumah;
...
public class Soal5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Ruang jogan pada Rumah Adat Panggung Kajang Leko dari Jambi ini memiliki fungsi sebagai…");
        a.setText("beristirahat dan sebagai tempat untuk menyimpan air.");
        b.setText("penerima tamu laki-laki.");
        c.setText("untuk memasak makanan dan sebagai tempat menyimpan air.");
        d.setText("Tempat tidur untuk anak perempuan yang belum menikah");
        gambar.setImageResource(R.drawable.rumah5);
    ...
    public void pindah() {
        if (habis == true || klik == true) {
            FragmentScore nextFragment = new FragmentScore();
