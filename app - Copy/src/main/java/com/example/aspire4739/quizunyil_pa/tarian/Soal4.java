...
public class Soal4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Tari Jlantur yang berasal dari Boyolali ini biasanya dimainkan oleh");
        a.setText("a. 20 Penari");
        b.setText("b. 30 Penari");
        c.setText("c. 40 Penari");
        d.setText("d. 50 Penari");
        gambar.setImageResource(R.drawable.tari4);
