...
public class Soal4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Trio Gili merupakan tiga pulau cantik yang ada di … . Ketiga pulau tersebut antara lain Gili Trawangan, Gili Meno dan Gili Air.");
        a.setText("Bali");
        b.setText("Lombok");
        c.setText("Papua");
        d.setText("Kalimantan");
