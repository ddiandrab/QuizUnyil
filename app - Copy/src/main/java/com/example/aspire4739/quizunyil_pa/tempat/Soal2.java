package com.example.aspire4739.quizunyil_pa.tempat;
...
public class Soal2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Hutan mangrove terletak di…");
        a.setText("Kepulauan Seribu");
        b.setText("Taman Mini Indonesia Indah");
        c.setText("Pantai Indah Kapuk");
        d.setText("Taman Safari");
        gambar.setImageResource(R.drawable.tempat2);
