...
public class Soal3 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //edit soal
        soal.setText("Pembacaan teks proklamasi Indonesia dilaksanakan di alamat...");
        a.setText("Lapangan Ikada");
        b.setText("Jalan Merdeka Barat");
        c.setText("Jalan Imam Bonjol");
        d.setText("Jalan Pegangsaan Timur");
